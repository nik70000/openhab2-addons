...
import org.openhab.binding.innogysmarthome.internal.client.exception.UnauthorizedException;
...
public class InnogyClient {
    ...
    private void initializeSession() throws IOException, ApiException {
        ...
        logger.info("innogy SmartHome Session initialized. Configuration version is {}",
